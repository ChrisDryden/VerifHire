...
USERS = ['Rama', 'Nick', 'Jose']
PROVIDERS = ['boo', 'doo', 'foo']
...
with open('database.sol') as file:
...
@app.route('/add_addresses', methods=['GET', 'POST'])
def index():
    alert = ''
...
def add_user():
    candidate_name = request.form.get('user')
    print(candidate_name)
    return render_template('index.html')

@app.route('/add_provider', methods=['POST'])
def add_provider():
    candidate_name = request.form.get('provider')
    print(candidate_name)
    return render_template('index.html')
